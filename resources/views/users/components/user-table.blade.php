            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6">
                    ...
                    <div>
                        ...
                        <strong>Contact Number : </strong><span id="view_contact"></span><br>
                        <strong>Date of Birth : </strong><span id="view_dob"></span><br>  
...
<script>
    ...
    $(document).ready(function(){
        $('.viewBtn').on('click', function(){
            ...
            document.getElementById('view_contact').innerHTML = data[4];
            document.getElementById('view_status').innerHTML = data[5];
            document.getElementById('view_email').innerHTML = data[6];
            document.getElementById('view_dob').innerHTML = data[7];
