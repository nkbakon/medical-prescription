    ...
    <div class="overflow-x-auto">
        <div class="flex w-full p-3 space-x-2">
            ...
            <div class="w-3/6">
                ...
                focus:outline-none focus:shadow-outline focus-ring-0 foucus:bg-indigo-50" placeholder="Search Drugs...">
            </div>
            <!-- Order By -->
            <div class="w-1/6">
    ...
    <div id="viewData" tabindex="-1" class="bg-opacity-50 fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
        <div class="relative w-full h-full max-w-md md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6">
                    <h3 class="mb-5 text-center text-xl font-normal text-gray-700 dark:text-gray-400">Drug Details</h3>
                    <div>
                        <strong>ID : </strong><span id="view_id"></span><br> 
                        <strong>Name : </strong><span id="view_name"></span><br>
                        <strong>Stock : </strong><span id="view_stock"></span><br>
                        <strong>Price : </strong><span id="view_price"></span><br>
                    </div>                                
                </div>
            </div>
        </div>
        ...
        <div class="relative w-full h-full max-w-md md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    <form method="POST" action="{{ route('drugs.destroy', 'data_id') }}">
                        @csrf
                        @method('DELETE')
...
<script>
    ...
    $(document).ready(function(){
        $('.viewBtn').on('click', function(){
            ...
            document.getElementById('view_stock').innerHTML = data[2];
            document.getElementById('view_price').innerHTML = data[3];
